...
const DEFAULT_FONT = 'bold 24px Outfit';
const DEFAULT_FONT_URL = 'https://fonts.googleapis.com/css2?family=Outfit:wght@500;700&display=swap';
...
function createTextTexture(gl, text, font = 'bold 24px sans-serif', color = '#1A1A18') {
...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#1A1A18', font = '24px sans-serif' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class Media {
  ...
  createShader() {
    ...
    // NOTE: Removed continuous sin/cos wiggling animation from vertex shader (p.z = 0.0) per request!
...
class App {
  ...
  createMedias(items, bend = 2.5, textColor, borderRadius, font) {
...
export default function CircularGallery({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Circular image gallery. Drag or use arrow keys to navigate photos."
    />
  );
}
